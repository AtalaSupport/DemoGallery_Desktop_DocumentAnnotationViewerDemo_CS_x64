...
This is the C# version of this demo. We also offer a [VB.NET version]( https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_DocumentAnnotationViewerDemo_VB_x64).
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_DocumentAnnotationViewerDemo_CS_x64.git DocumentAnnotationViewerDemo --recursive
